...
CREATE TABLE `jenis` (
  ...
  `Project No` varchar(20) NOT NULL,
  `nama_jenis` varchar(20) NOT NULL,
  `Customer` varchar(20) NOT NULL,
  `End_User` varchar(20) NOT NULL,
  `Project_Management` varchar(20) NOT NULL,
  `Panel_Vendor` varchar(20) NOT NULL,
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
INSERT INTO `jenis` (`id_jenis`, `Project_Np`, `nama_jenis`, `Customer`, `End_User`, `Project_Management`, `Panel_Vendor`) VALUES
(8, 'Machinery'),
...
--
-- Table structure for table `detail_qc`
--

CREATE TABLE `detail_qc` (
  `id_detail_qc` int(200) NOT NULL,
  `Substation_Name` varchar(200) NULL,
  `Panel_No` int(200) NULL,
  `Panel_Name` varchar(200) NULL,
  `Panel_Type` varchar(200) NULL,
  `Panel_Received` date NOT NULL,
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

--
-- Dumping data for table `detail_qc`
--

INSERT INTO `detail_qc` (`id_detail_qc`, `Substation_Name`, `Panel_No`, `Panel_Name`, `Panel_Type`, `Panel_Received`) VALUES
(8, 'Machinery'),
(9, 'Computer Accessories'),
(10, 'Cleaning Supplies'),
(11, 'Repair Tools'),
...
--
-- Indexes for table `detail_qc`
--
ALTER TABLE `detail_qc`
  ADD PRIMARY KEY (`id_detail_qc`) USING BTREE;
...
--
-- AUTO_INCREMENT for table `detail_qc`
--
ALTER TABLE `detail_qc`
  MODIFY `id_detail_qc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16
--
