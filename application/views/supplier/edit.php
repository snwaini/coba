        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="nama_supplier">Customer Name</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-fw fa-user"></i></span>
                            </div>
                            <input value="<?= set_value('nama_supplier', $supplier['nama_supplier']); ?>" name="nama_supplier" id="nama_supplier" type="text" class="form-control" placeholder="Customer Name">
                        </div>
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="alamat">Customer Address</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-fw fa-location-arrow"></i></span>
                            </div>
                            <textarea name="alamat" id="alamat" class="form-control" rows="4" placeholder="Customer Full Address"><?= set_value('alamat', $supplier['alamat']); ?></textarea>
                        </div>
