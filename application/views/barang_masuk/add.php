        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="id_barang_masuk">Serial Number</label>
                    <div class="col-md-4">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="tanggal_masuk">Entry Date</label>
                    <div class="col-md-4">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="barang_id">Panel Name</label>
                    <div class="col-md-5">
                        <div class="input-group">
                            <select name="barang_id" id="barang_id" class="custom-select">
                                <option value="" selected disabled>Select Panel Name..</option>
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="jumlah_masuk">Qty & PM </label>
                    <div class="col-md-5">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <span class="input-group-text" id="satuan">PM</span>
                            </div>
                        </div>
