...
<head>
    ...
    <title><?= $title; ?> Monitoring Quality Control</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">Monitoring Quality Control</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Master of Data:</h6>
                        <a class="collapse-item" href="<?= base_url('jenis'); ?>">Project Infomation</a>
                        <a class="collapse-item" href="<?= base_url('detail_qc'); ?>">Detail QC</a>
                    </div>
                </div>
            </li>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Monitoring Quality Control 2023 &bull; by <?= anchor('https://docs.google.com/forms/d/1VGtK7l_7q1YNHjBPIhsbERbt6xCAyACIJ9QIjLXQT00/edit?ts=63b3f32a', 'Departemen Teknik Elektro Otomasi, ITS'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <?php if ($this->uri->segment(1) == 'dashboard') : ?>
        ...
        <script type="text/javascript">
            ...
            var myPieChart = new Chart(ctx, {
                type: 'doughnut',
                data: {
                    labels: ["Capasity Panel", "Total Panel in Testing Area"],
                    datasets: [{
