        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="id_barang">Serial Number</label>
                    <div class="col-md-9">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="nama_barang">Panel Name</label>
                    <div class="col-md-9">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="jenis_id">Project Name</label>
                    <div class="col-md-9">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="satuan_id">Project Management</label>
                    <div class="col-md-9">
                        <div class="input-group">
