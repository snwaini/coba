        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('Project_Year'); ?>" name="Project_Year" id="Project_Year" type="text" class="form-control" placeholder="Project Year...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('Project_No'); ?>" name="Project_No" id="Project_No" type="text" class="form-control" placeholder="Project No...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('nama_jenis'); ?>" name="nama_jenis" id="nama_jenis" type="text" class="form-control" placeholder="Project Name...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('Customer'); ?>" name="Customer" id="Customer" type="text" class="form-control" placeholder="Customer...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('End_User'); ?>" name="End_User" id="End_User" type="text" class="form-control" placeholder="End User...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('Project_Management'); ?>" name="Project_Management" id="Project_Management" type="text" class="form-control" placeholder="Project Management...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('Panel_Vendor'); ?>" name="Panel_Vendor" id="Panel Vendor" type="text" class="form-control" placeholder="Panel Vendor...">
